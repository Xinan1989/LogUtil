...
/**
 * Des:UncaughtException处理类,当程序发生Uncaught异常的时候,有该类来接管程序,并记录发送错误报告.
...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    private boolean handleException(Throwable ex) {
        ...
        new Thread() {
            ...
            public void run() {
                Looper.prepare();
//                Toast.makeText(mContext, Constants.CRASH, Toast.LENGTH_SHORT).show();
    ...
    private String getFilePath() {
        ...
        if (isSDCardExist && isRootDirExist) {
            file_dir = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "LogUtilDemo"+ File.separator + "crashlog/";
    ...
    private String saveCatchInfo2File(Throwable ex) {
        ...
        try {
            ...
            String fileName = "crash-" + time +"_"+SystemUtil.getDeviceBrand()+"_"+SystemUtil.getSystemModel()+"_"+SystemUtil.getSystemVersion()+ ".log";
